...
```bash
cp .env.example .env
# Отредактируй .env — добавь TELEGRAM_API_ID, TELEGRAM_API_HASH, ADMIN_BOT_TOKEN,
# LLM_PROVIDER (openrouter/dashscope) и соответствующий OPENROUTER_API_KEY или DASHSCOPE_API_KEY
