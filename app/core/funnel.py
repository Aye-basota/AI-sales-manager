...
DEFAULT_FUNNEL_STAGES: list[dict[str, Any]] = [
    {
        "stage": "hook",
        "goal": "Мягко зацепить внимание потенциального клиента и получить отклик.",
        "max_length": 200,
        ...
        "instructions": (
            ...
            "Цель — лёгкий контакт и интерес."
        ),
    },
    {
        "stage": "qualification",
        "goal": "Выявить потребность, роль и ситуацию клиента.",
        "max_length": 350,
        "allow_call_to_action": False,
        "instructions": (
            "Задай 1 короткий уточняющий вопрос о бизнесе/задаче клиента. "
            "Пока не предлагай созвон."
        ),
    },
    {
        "stage": "value",
        "goal": "Показать ценность решения на основе ответов клиента.",
        "max_length": 400,
        "allow_call_to_action": False,
        "instructions": (
            "Коротко объясни, как именно продукт решает озвученную проблему. "
            "Можно намекнуть на возможность обсудить детали, но не назначай звонок напрямую."
        ),
    },
    {
        "stage": "cta",
