...
DEFAULT_FUNNEL_STAGES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "allow_call_to_action": False,
        "instructions": (
            "Если без уточнения нельзя продолжить, задай 1 короткий открытый вопрос о задаче клиента. "
            "Если контекста уже достаточно, лучше коротко ответь по сути без нового вопроса. "
    ...
    },
    {
        ...
        "allow_call_to_action": False,
        "instructions": (
            "Если нужна деталь, задай 1 короткий уточняющий вопрос о задаче клиента. "
            "Если вопрос уже был, лучше предложи короткую демо-запись или полезный кейс, "
            "чтобы показать, как работает решение без давления. "
